      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-6 bg-gray-900 border border-gray-800">
            <TabsTrigger value="upload" className="data-[state=active]:bg-veloz-yellow data-[state=active]:text-veloz-black">Import Vehicles</TabsTrigger>
            <TabsTrigger value="inventory" className="data-[state=active]:bg-veloz-yellow data-[state=active]:text-veloz-black">Inventory ({vehicles.length})</TabsTrigger>
          </TabsList>
